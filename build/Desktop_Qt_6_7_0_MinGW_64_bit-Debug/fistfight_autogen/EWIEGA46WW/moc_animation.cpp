...
struct qt_meta_stringdata_CLASSAnimationENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSAnimationENDCLASS = QtMocHelpers::stringData(
    "Animation"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSAnimationENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Animation::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSAnimationENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSAnimationENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSAnimationENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *Animation::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSAnimationENDCLASS.stringdata0))
