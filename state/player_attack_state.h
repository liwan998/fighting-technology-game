...
class Player_Attack_State : public State_Node
{
    Q_OBJECT
public:
    explicit Player_Attack_State(Player::Player_select player_select,QObject *parent = nullptr);
    ~Player_Attack_State()=default;
